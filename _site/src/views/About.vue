      ...
      <div class="section profile-content">
        <div class="container">
          <div class="md-layout">
            <div class="md-layout-item md-size-50 mx-auto">
              <div class="profile">
                ...
                <div class="name">
                  <h3 class="title">About Muslimah</h3>
                  <h6>App</h6>
                </div>
              </div>
            </div>
          ...
          <div class="description text-center">
            <p>Write a little blurb about what Muslimah app can do! Discuss your vision and mission to change the world. </p>
          </div>
          <div class="profile-tabs">
            <tabs
              :tab-name="['A Voice', 'A Platform', 'A Sisterhood']"
              :tab-icon="['mic', 'language', 'group_work']"
              plain
              nav-pills-icons
...
export default {
  ...
  props: {
    ...
    img: {
      type: String,
      default: require("@/assets/img/faces/logo-1.png")
    }
  },
  computed: {
    headerStyle() {
