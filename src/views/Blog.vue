    ...
    <parallax class="section page-header header-filter" :style="headerStyle">
      <div class="container">
        <div class="md-layout">
              ...
              <h4>See what other Muslimah women are discussing around the world.</h4>
              	</div>
        </div>
      </div>
    </parallax>
        ...
        <div class="container">
          <div class="md-layout">
            <ul class="nav nav-pills nav-pills-rose">
                <li class="nav-item"><a class="nav-link active" href="#pill1" data-toggle="tab">Faith</a></li>
                <li class="nav-item"><a class="nav-link" href="#pill2" data-toggle="tab">Food</a></li>
                <li class="nav-item"><a class="nav-link" href="#pill3" data-toggle="tab">Fashion</a></li>
            </ul>
